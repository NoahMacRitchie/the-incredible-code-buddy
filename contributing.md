...
1. Login into (Discord Developer Panel)[https://discordapp.com/developers/applications]
...
```
DISCORD_KEY=ODIwMzc1MDMzODU4NzUyNjI0.YE0PyQ.B4QaITi6uMLvtJK2zt6y_LDTBQ8
```
### Add your bot to a server
1. Insert `<YOUR_API_KEY>` and paste the following link into your browser
```
https://discord.com/oauth2/authorize?client_id=<YOU_API_KEY>&permissions=1133584&scope=bot
```
